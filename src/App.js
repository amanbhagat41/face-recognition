...
import Particle from './componets/Particles/Particle';
...
class App extends React.Component {
  ...
  onButtonSubmit = () => {
    ...
    fetch('https://thawing-sands-13032.herokuapp.com/imageurl', {
         method: 'post',
    ...
    .then(response => {
      if(response) {
        fetch('https://thawing-sands-13032.herokuapp.com/image', {
         method: 'put',
         headers: {'Content-Type' : 'application/json'},
         body: JSON.stringify({
